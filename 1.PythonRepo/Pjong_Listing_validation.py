...
path_csv = "C:/0.bigdata/4.web/Triple_Core/0.DataRepo/0.StockData/csv_data/"
path_info = "C:/0.bigdata/4.web/Triple_Core/0.DataRepo/0.StockData/"
...
def check_symbol_info():
    ...
    if 'symbol_info_update.csv' not in check_exist_info:
        ...
        for file in csv_list:
            symbol_new = pd.read_csv("C:/0.bigdata/4.web/Triple_Core/0.DataRepo/0.StockData/csv_data/"+ file)  
            symbol_info=symbol_info.append(symbol_new)
        symbol_info.to_csv("C:/0.bigdata/4.web/Triple_Core/0.DataRepo/0.StockData/symbol_info.csv", index=False, sep=",", encoding='‘utf-8’')
        
def listing_validation():
    check_symbol_info()
    symbol_info = pd.read_csv("C:/0.bigdata/4.web/Triple_Core/0.DataRepo/0.StockData/symbol_info.csv")
