...
def initiate_to_validate_ListingStatus():
    ...
    initial_validated_data_df.columns = ["Name", "Symbol", "Exchange", "Sector", "Industry", "Listing_status", "Delisting_date", "New_listing_date"]
...
#                print("====================================")
                ...
                new_listing_data.columns = ["Name", "Symbol", "Exchange", "Sector", "Industry", "Listing_status", "Delisting_date", "New_listing_date"]
                old_validated_data_df = old_validated_data_df.append(new_listing_data, ignore_index=True)
            
        old_validated_data_df.columns = ["Name", "Symbol", "Exchange", "Sector", "Industry", "Listing_status", "Delisting_date", "New_listing_date"]
        old_validated_data_df.to_csv(processed_data_path + "/" + old_validated_data, sep=",", index=False, encoding="UTF-8")
